...
const Home = () => {
  ...
  {/* Carousel Container */}
  <div className="carousel-container flex md:justify-center overflow-x-auto scrollbar-hide snap-x snap-mandatory sm:space-x-2 sm:p-4 md:w-full md:space-x-0 md:p-0">
